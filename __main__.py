from src.proyectofindecurso.modelo.Asignatura import Asignatura, AsignaturaEstudiante
...
from src.proyectofindecurso.modelo.declarative_base import Session, engine, Base
